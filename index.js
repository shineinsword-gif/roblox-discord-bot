...
client.once('ready', async () => {
  ...
  if (guild) {
    // Register commands directly to guild (instant, no waiting)
...
client.on('interactionCreate', async (interaction) => {
  ...
  if (commandName === 'stock') {
    console.log(`📊 Stock command used by ${interaction.user.tag}`);
...
console.log('🚀 Bot starting with simplified working version...');
